...
CREATE TABLE cutting_tasks (
  ...
  date DATE NOT NULL,
  progress DECIMAL(5, 2) NOT NULL CHECK (
    progress >= 0
    AND progress <= 100
  ),
...
CREATE TABLE loans (
  ...
  borrower_type ENUM('employee', 'contractor') NOT NULL,
  amount DECIMAL(15, 2) NOT NULL,
  interest_rate DECIMAL(5, 2) NOT NULL,
  term_months INT NOT NULL,
  payment_frequency ENUM('weekly', 'monthly', 'quarterly', 'annually') NOT NULL DEFAULT 'monthly',
  start_date DATE NOT NULL,
  end_date DATE NOT NULL,
  purpose TEXT,
  collateral TEXT,
